  ...
  $.getScript('https://cdnjs.cloudflare.com/ajax/libs/socket.io/2.1.1/socket.io.js')
    .done(function() {
      ...
      ext.rotation_shape = function(rotationX, rotationY) {
        let command = "rotation_shape:" + rotationX + ":" + rotationY;
        socket.emit("from_client", JSON.stringify({roomId: roomId, command: command}));
      }
      ...
      var locale = {
        ja: {
          ...
          rotation_shape: '基本形状を回転する。rotationX: %n rotationY: %n',
        ...
        en: {
          ...
          rotation_shape: 'rotation basic shape: rotationX: %n rotationY: %n',
      ...
      var descriptor = {
        blocks: [
          ...
          [' ', locale[lang].rotation_shape, 'rotation_shape', 0, 0],
