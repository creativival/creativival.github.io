    ...
    .done(function() {
      ...
      var locale = {
        ja: {
          ...
          polygon_file_format: '3Dモデルを作成。x座標を %n 、y座標を %n 、z座標を %n 、CSVファイル %s',
        ...
        en: {
          ...
          polygon_file_format: 'create 3d model at x: %n y: %n z: %n csv file: %s',
      ...
      var descriptor = {
        blocks: [
          ...
          [' ', locale[lang].polygon_file_format, 'polygon_file_format', 0, 0, 10, 'CommaSpearatedValue'],
